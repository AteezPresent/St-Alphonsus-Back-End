...
<form  method="post" action="UpdateTeacher.php">
        ...
        <input type="text" name="tid" id="tid" placeholder="tid">
           ...
           <i class=""></i><label<label for="taddress">Teacher Address</label>
            ...
            <input  type="text" name="tannualleave" id="annualleave" placeholder="annualleave">
            <br>
            <br>
      ...
      $sql = "UPDATE teacher SET tname='$tname' , taddress='$taddress', tmobile='$tmobile', tannualleave='$tannualleave'  WHERE tid=$tid";
