...
<br>
   ...
   <table>
    <tr>
        ...
        <th width="250px">Student Medical<br><hr></th>
        <th width="250px">Parent ID<br><hr></th>
        <th width="250px">Class ID<br><hr></th>
        <th width="250px">Uniform ID<br><hr></th>
        

</tr>
<?php
$sql = mysqli_query($link,"SELECT sid,sname,saddress,smedical,pid,cid,uid FROM student");
