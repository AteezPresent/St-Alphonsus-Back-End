...
<form  method="post" action="UpdateParent.php">
        ...
        <input type="text" name="pid" id="pid" placeholder="pid">
           ...
           <i class=""></i><label<label for="pname">Parent Name</label>
            <input  type="text" name="pname" id="pname" placeholder="pname">
           <br>
           <br>
           <i class=""></i><label<label for="paddress">Parent Address</label>
            <input  type="text" name="paddress" id="paddress" placeholder="paddress">
            <br>
            <br>
            <i class=""></i><label<label for="pmobile">Parent Mobile</label>
            <input  type="text" name="pmobile" id="pmobile" placeholder="pmobile">
      ...
      $sql = "UPDATE parent SET pname='$pname' , paddress='$paddress', pmobile='$pmobile' WHERE pid=$pid";
