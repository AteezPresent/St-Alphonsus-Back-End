...
<script>
   ...
   {
let v = document.forms["myform"]["uid"].value;
let w = document.forms["myform"]["uname"].value;
...
<form name="myform" method="post" action="AddUniform.php"onsubmit="return validateForm()">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            <i class=""></i><label<label for="uid">Uniform ID:</label>
         <input type="text" name="uid" id="uid" placeholder="uid">
           <br>
           <br>
           <i class=""></i><label<label for="usize">Uniform Size</label>
            <input  type="text" name="usize" id="usize" placeholder="usize">
           <br>
           <br>
           <i class=""></i><label<label for="uitem">Uniform Item</label>
            <input  type="text" name="uitem" id="uitem" placeholder="uitem">
            <br>
            <br>
...
$sql="INSERT INTO uniform(uid,usize,uitem)  VALUES ('$uid','$usize','$uitem')";
