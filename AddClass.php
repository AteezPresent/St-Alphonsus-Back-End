...
<form  method="post" action="AddClass.php">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            <i class=""></i><label<label for="cid">Class ID:</label>
         <input type="text" name="cid" id="cid" placeholder="cid">
           <br>
           <br>
           <i class=""></i><label<label for="cname">Class Name</label>
            <input  type="text" name="cname" id="cname" placeholder="cname">
           <br>
           <br>
           <i class=""></i><label<label for="croom">Class Room</label>
            <input  type="text" name="croom" id="croom" placeholder="croom">
            <br>
            <br>
            <i class=""></i><label<label for="ccapacity">Class Capacity</label>
            <input  type="text" name="ccapacity" id="ccapacity" placeholder="ccapacity">
            <br>
            <br>
...
$sql="INSERT INTO class(cid,cname,croom,ccapacity,tid) VALUES ('$cid','$cname','$croom','$ccapacity','$tid')";
