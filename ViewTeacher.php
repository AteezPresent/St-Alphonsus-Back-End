...
?>
   ...
   <table>
    <tr>
        ...
        <th width="250px">Teacher Mobile<br><hr></th>
        <th width="250px">Teacher Annual Leave<br><hr></th>
        <th width="250px">Wage ID<br><hr></th>
        

</tr>
<?php
$sql = mysqli_query($link,"SELECT tid,tname,taddress,tmobile,tannualleave,wid FROM teacher");
