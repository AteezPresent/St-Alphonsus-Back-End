...
<body>
   ...
   <?php
        ...
        ?>
<br>
<form  method="post" action="UpdateWage.php">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            <i class=""></i><label<label for="wid"> Wage ID:</label>
        <input type="text" name="wid" id="wid" placeholder="wid">
           <br>
           <br>
         <i class=""></i><label<label for="wamount">Wage Amount</label>
            <input  type="text" name="wamount" id="wamount" placeholder="wamount">
            <br>
            <br>
      ...
      $sql = "UPDATE wage SET wamount='$wamount'  WHERE wid=$wid";
