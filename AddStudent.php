...
<form   name="myform" method="post" action="AddStudent.php" onsubmit="return validateForm()">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            <i class=""></i><label for="sid">Student ID:</label>
         <input type="text" name="sid" id="sid" placeholder="sid">
           <br>
           <br>
           <i class=""></i><label for="sname">Student Name</label>
            <input  type="text" name="sname" id="sname" placeholder="sname">
           <br>
           <br>
           <i class=""></i><label for="saddress">Student Address</label>
            <input  type="text" name="saddress" id="saddress" placeholder="saddress">
            <br>
            <br>
            <i class=""></i><label for="smedical">Student Medical</label>
...
$sql="INSERT INTO student(sid,sname,saddress,smedical,pid,cid,uid) VALUES ('$sid','$sname','$saddress','$smedical','$pid','$cid','$uid')";
